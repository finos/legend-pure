...
public class EnumerationMappingUnloaderWalk implements MatchRunner<EnumerationMapping>
{
    @Override
    ...
    {
        matcher.fullMatch(ImportStub.withImportStubByPass(enumerationMapping._parentCoreInstance(), state.getProcessorSupport()), state);
    }
}

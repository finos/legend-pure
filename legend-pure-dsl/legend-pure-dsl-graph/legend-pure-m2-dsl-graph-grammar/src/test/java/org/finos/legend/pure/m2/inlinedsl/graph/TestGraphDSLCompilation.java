...
public class TestGraphDSLCompilation extends AbstractPureTestWithCoreCompiled
{
    ...
    {
        runtime.createInMemorySource("file.pure", "Class Person{address:Address[1];} Class Firm {employees:Person[1];address:Address[1];} Class Address{}\n" +
                "function test():Any[*]\n" +
                "{\n" +
        ...
        Assert.assertEquals("Compilation error at (resource:file.pure line:4 column:13), \"UnknownFirm has not been defined!\"", e1.getMessage());
        ...
        Assert.assertEquals("Compilation error at (resource:file.pure line:4 column:18), \"The system can't find a match for the property / qualified property: employees1()\"", e2.getMessage());
        ...
        Assert.assertEquals("Compilation error at (resource:file.pure line:4 column:28), \"The system can't find a match for the property / qualified property: address1()\"", e3.getMessage());
    ...
    {
        //SubType
        runtime.createInMemorySource("file.pure", "Class Person{address:Address[1];} Class Firm {employees:Person[1];address:Address[1];} Class Address{} Class FirmAddress extends Address{} Class PersonAddress extends Address{}\n" +
                "function test():Any[*]\n" +
                "{\n" +
        ...
        runtime.modify("file.pure", "Class Person{address:Address[1];} Class Firm {employees:Person[1];address:Address[1];} Class Address{} Class FirmAddress extends Address{} Class PersonAddress extends Address{}\n" +
                "function test():Any[*]\n" +
                "{\n" +
    ...
    public void testGraphWithImports()
    {
        ...
        runtime.modify("file.pure", "import meta::relational::tests::mapping::enumeration::model::domain::*;\n" +
                "Class meta::relational::tests::mapping::enumeration::model::domain::Product\n" +
                "{\n" +
                "   description: String[1];\n" +
                "   synonyms: ProductSynonym[*];\n" +
    ...
    public void testGraphPropertyParameters()
    {
        ...
        runtime.createInMemorySource("function.pure",
                "function test():Any[*]\n" +
                        ...
                        "}\n");
        PureCompilationException e1 = Assert.assertThrows(PureCompilationException.class, runtime::compile);
        Assert.assertEquals("Compilation error at (resource:function.pure line:3 column:20), \"The system can't find a match for the property / qualified property: nameWithTitle()\"", e1.getMessage());
        ...
        runtime.modify("function.pure",
                "function test():Any[*]\n" +
                        ...
                        "}\n");
        PureCompilationException e2 = Assert.assertThrows(PureCompilationException.class, runtime::compile);
        Assert.assertEquals("Compilation error at (resource:function.pure line:3 column:20), \"The system can't find a match for the property / qualified property: nameWithTitle(_:Integer[1])\"", e2.getMessage());
    ...
    public void testMultipleParameters()
    {
        ...
        runtime.modify("function.pure",
                "function test():Any[*]\n" +
                        ...
                        "}\n");
        PureCompilationException e1 = Assert.assertThrows(PureCompilationException.class, runtime::compile);
        Assert.assertEquals("Compilation error at (resource:function.pure line:3 column:20), \"The system can't find a match for the property / qualified property: nameWithPrefixAndSuffix(_:String[1],_:Integer[2])\"", e1.getMessage());
        ...
        runtime.modify("function.pure",
                "function test():Any[*]\n" +
                        ...
                        "}\n");
        PureCompilationException e2 = Assert.assertThrows(PureCompilationException.class, runtime::compile);
        Assert.assertEquals("Compilation error at (resource:function.pure line:3 column:20), \"The system can't find a match for the property / qualified property: nameWithPrefixAndSuffix(_:String[1],_:Any[2])\"", e2.getMessage());
        ...
        runtime.modify("function.pure",
                "function test():Any[*]\n" +
                        ...
                        "}\n");
        PureCompilationException e3 = Assert.assertThrows(PureCompilationException.class, runtime::compile);
        Assert.assertEquals("Compilation error at (resource:function.pure line:3 column:20), \"The system can't find a match for the property / qualified property: nameWithPrefixAndSuffix(_:String[1])\"", e3.getMessage());
    ...
    public void testVariables()
    {
        ...
        runtime.modify("function.pure",
                "function test():Any[*]\n" +
                        ...
                        "}\n");
        PureCompilationException e1 = Assert.assertThrows(PureCompilationException.class, runtime::compile);
        Assert.assertEquals("Compilation error at (resource:function.pure line:4 column:20), \"The system can't find a match for the property / qualified property: nameWithPrefixAndSuffix(_:String[1],_:Integer[2])\"", e1.getMessage());
        ...
        runtime.modify("function.pure",
                "function test():Any[*]\n" +
                        ...
                        "}\n");
        PureCompilationException e2 = Assert.assertThrows(PureCompilationException.class, runtime::compile);
        Assert.assertEquals("Compilation error at (resource:function.pure line:4 column:20), \"The system can't find a match for the property / qualified property: nameWithPrefixAndSuffix(_:String[1],_:Any[2])\"", e2.getMessage());
        ...
        runtime.modify("function.pure",
                "function test():Any[*]\n" +
                        ...
                        "}\n");
        PureCompilationException e3 = Assert.assertThrows(PureCompilationException.class, runtime::compile);
        Assert.assertEquals("Compilation error at (resource:function.pure line:4 column:20), \"The system can't find a match for the property / qualified property: nameWithPrefixAndSuffix(_:String[1])\"", e3.getMessage());

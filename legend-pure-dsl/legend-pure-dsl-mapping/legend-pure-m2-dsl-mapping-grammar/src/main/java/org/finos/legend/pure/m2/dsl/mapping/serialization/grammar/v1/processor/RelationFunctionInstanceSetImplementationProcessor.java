...
public class RelationFunctionInstanceSetImplementationProcessor extends Processor<RelationFunctionInstanceSetImplementation>
{
    ...
    {
        RelationType<?> newRelationType = _RelationType.build(Lists.mutable.with(_Column.getColumnInstance(propertyMapping._column()._name(), false, property._genericType(), property._multiplicity(), sourceInformation, processorSupport)), sourceInformation, processorSupport);

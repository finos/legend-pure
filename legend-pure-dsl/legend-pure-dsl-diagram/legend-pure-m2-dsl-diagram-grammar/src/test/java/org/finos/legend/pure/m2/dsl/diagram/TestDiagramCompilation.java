...
public class TestDiagramCompilation extends AbstractPureTestWithCoreCompiled
{
    ...
    public void testTypeViewWithNonExistentType()
    {
        ...
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.typeViews, processorSupport));
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.associationViews, processorSupport));
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.propertyViews, processorSupport));
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.generalizationViews, processorSupport));
    }
    ...
    public void testAssociationViewWithNonExistentAssociation()
    {
        ...
        CoreInstance diagram = runtime.getCoreInstance("test::pure::TestDiagram");
        Assert.assertNotNull(diagram);
        Assert.assertEquals(2, Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.typeViews, processorSupport).size());
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.associationViews, processorSupport));
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.propertyViews, processorSupport));
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.generalizationViews, processorSupport));
    }
    ...
    public void testGeneralizationViewWithNonExistentTarget()
    {
        ...
        CoreInstance diagram = runtime.getCoreInstance("test::pure::TestDiagram");
        Assert.assertNotNull(diagram);
        Assert.assertEquals(1, Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.typeViews, processorSupport).size());
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.associationViews, processorSupport));
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.propertyViews, processorSupport));
        Assert.assertEquals(Lists.fixedSize.empty(), Instance.getValueForMetaPropertyToManyResolved(diagram, M3Properties.generalizationViews, processorSupport));
    }

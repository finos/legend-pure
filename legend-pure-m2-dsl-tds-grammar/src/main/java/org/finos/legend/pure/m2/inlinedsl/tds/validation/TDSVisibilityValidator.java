...
package org.finos.legend.pure.m2.inlinedsl.tds.validation;
...
public class TDSVisibilityValidator implements VisibilityValidator
{
    @Override
    ...
    {
        if (processorSupport.package_getByUserPath(M2TDSPaths.TDS) != null && Instance.instanceOf(value, M2TDSPaths.TDS, processorSupport))
        {

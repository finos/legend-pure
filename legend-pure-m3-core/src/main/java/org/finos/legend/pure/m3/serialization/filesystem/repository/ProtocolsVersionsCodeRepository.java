...
public class ProtocolsVersionsCodeRepository extends SVNCodeRepository
{
    ...
    public boolean isVisible(CodeRepository other)
    {
        ...
        if ((other != null && other.getName() != null && other.getName().startsWith("platform")) || CodeRepositoryProviderHelper.isCoreRepository(other) || (other instanceof SystemCodeRepository))
        {
            return true;
        }

...
public final class ModelCodeRepository extends SVNCodeRepository
{
    ...
    public boolean isVisible(CodeRepository other)
    {
        ...
        if ((other != null && other.getName() != null && other.getName().startsWith("platform")) || (other instanceof SystemCodeRepository) || CodeRepositoryProviderHelper.isCoreRepository(other))
        {
            return true;
        }

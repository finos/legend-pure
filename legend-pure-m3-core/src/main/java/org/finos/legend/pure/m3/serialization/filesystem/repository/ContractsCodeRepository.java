...
public final class ContractsCodeRepository extends SVNCodeRepository
{
    ...
    public boolean isVisible(CodeRepository other)
    {
        ...
        return (other instanceof ContractsCodeRepository) || CodeRepositoryProviderHelper.isCoreRepository(other) || (other instanceof SystemCodeRepository) || (other != null && other.getName() != null && other.getName().startsWith("platform"));
    }
}

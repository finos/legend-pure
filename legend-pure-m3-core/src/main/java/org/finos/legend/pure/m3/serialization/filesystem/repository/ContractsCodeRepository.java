...
public final class ContractsCodeRepository extends SVNCodeRepository
{
    ...
    public boolean isVisible(CodeRepository other)
    {
        ...
        return (other instanceof ContractsCodeRepository) || (other instanceof CoreCodeRepository) || (other instanceof SystemCodeRepository) || (other instanceof PlatformCodeRepository);
    }
}

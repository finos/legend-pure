...
public interface VCSCodeStorageBuilder
{
    ListIterable<? extends RepositoryCodeStorage> createPureCodeStorage(Iterable<? extends SVNCodeRepository> svnCodeRepositories);
}

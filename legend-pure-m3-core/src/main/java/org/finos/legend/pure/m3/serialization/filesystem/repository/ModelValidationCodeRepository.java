...
public final class ModelValidationCodeRepository extends SVNCodeRepository
{
    ...
    {
        return (this == other) || (other instanceof ModelValidationCodeRepository) || (other instanceof ModelCodeRepository) || CodeRepositoryProviderHelper.isCoreRepository(other) || (other instanceof SystemCodeRepository) || (other != null && other.getName() != null && other.getName().startsWith("platform"));
    }
}

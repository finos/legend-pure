...
public final class ModelValidationCodeRepository extends SVNCodeRepository
{
    ...
    {
        return (this == other) || (other instanceof ModelValidationCodeRepository) ||  (other instanceof ModelCodeRepository)  || (other instanceof CoreCodeRepository) || (other instanceof SystemCodeRepository) || (other instanceof PlatformCodeRepository);
    }
}

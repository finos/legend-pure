    ...
    public void populateReferenceUsages(InstanceValue instance, ModelRepository repository, ProcessorSupport processorSupport)
    {
        ...
        else
        {
            values.forEachWithIndex((value, i) ->
            {
                ...
                if (Instance.instanceOf(value, M3Paths.PackageableElement, processorSupport) || Instance.instanceOf(value, M3Paths.RelationPointer, processorSupport) || Instance.instanceOf(value, M3Paths.Function, processorSupport))
                {

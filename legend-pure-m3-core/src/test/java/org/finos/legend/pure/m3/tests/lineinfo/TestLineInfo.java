...
public class TestLineInfo extends AbstractPureTestWithCoreCompiledPlatform
{
    ...
    public void testLineInfoForDynamicInstanceGeneratedM3() throws Exception
    {
        ...
        assertSourceInformation("/platform/pure/grammar/m3.pure", 1008, 13, 1008, 126, 1015, 17, classifierGenericType.getSourceInformation());
        ...
        // Note: these source coordinates may change if m3.pure changes
        assertSourceInformation("/platform/pure/grammar/m3.pure", 2251, 1, 2251, 88, 2275, 1, funcType.getSourceInformation());
    }

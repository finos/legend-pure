...
public class TestCodeRepository extends CodeRepository
{
    public TestCodeRepository(String name, Pattern allowedPackagesPattern)
    {
        super(name, allowedPackagesPattern);
    }

    public TestCodeRepository(String name)
    {
        this(name, null);
    }

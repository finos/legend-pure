...
public class TestSearchTools extends AbstractPureTestWithCoreCompiledPlatform
{
    ...
    public void testFindInAllPackages()
    {
        ...
        Verify.assertSetsEqual(Sets.mutable.with(test_TestClass, test_searchTools_TestClass), SearchTools.findInAllPackages("TestClass", this.runtime.getModelRepository()).toSet());
        ...
        Verify.assertSetsEqual(Sets.mutable.with(test_TestClass1, test_TestClass2, test_searchTools_TestClass2, test_TestAssociation1, test_searchTools_TestAssociation1),

...
public abstract class AbstractTestMeasure extends AbstractPureTestWithCoreCompiled
{
    ...
    private static String plusFunction =
    ...
    private static String minusFunction =
    ...
    private static String multFunction =
    ...
    private static String divFunction =
    ...
    public void testUnitInstantiatesAndReturnsFromFunction()
    {
        ...
        Assert.assertEquals("Mass~Pound", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("1", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
        ...
        try
        {
            compileTestSource(
                    ...
                    "import pkg::*;\n" +
                            ...
                            "}");
            Assert.fail("Expect parser exception.");
        }
        catch (Exception e)
        {
    ...
    public void testUnitPassedInFunctionAsUnitReturnsUnit()
    {
        ...
        Assert.assertEquals("Mass~Kilogram", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
    ...
    public void testKilogramInstanceOfKilogram()
    {
        ...
        Assert.assertEquals("true", result.getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testInstantiateUnitWithNewUnit()
    {
        ...
        Assert.assertEquals("Mass~Pound", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("10", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testGetUnitValue()
    {
        ...
        Assert.assertEquals("Integer", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("5", result.getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testCrossUnitAddition()
    {
        ...
        Assert.assertTrue("Mass~Gram".equals(GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport)));
        Assert.assertEquals("5550", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testOperationWithUnitAsMass()
    {
        ...
        Assert.assertEquals("Mass~Gram", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("5907.18", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testCrossUnitSubtraction()
    {
        ...
        CoreInstance result = execute("testFunc():Any[1]");
        Assert.assertEquals("Mass~Gram", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("4650", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testKilogramInstanceAsClassProperty()
    {
        ...
        Assert.assertEquals("Mass~Pound", GenericType.print(lb.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("5", lb.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testInvokingClassQualifiedPropertyWithUnit()
    {
        ...
        Assert.assertEquals("Mass~Gram", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("2453.59", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testPlusWithAtFunctionOnSingletonUnitInstance()
    {
        ...
        CoreInstance result = execute("testParamsWrapper():Mass~Gram[1]");
        Assert.assertEquals("Mass~Gram", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("6360.77", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testUnitScalarMultiplication()
    {
        ...
        Assert.assertEquals("Mass~Gram", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("9000", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testUnitScalarDivision()
    {
        ...
        Assert.assertEquals("Mass~Gram", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("3000.0", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testKilogramPropertyListedInClassProperties()
    {
        ...
        Assert.assertEquals("1", result.getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testMultipleUnitRelatedPropertiesListedInClassProperties()
    {
        ...
        compileTestSource("testFunc.pure",
                "import pkg::*;\n" +
                        ...
                        "}\n");
        CoreInstance result = execute("testFunc():Any[*]");
        Assert.assertEquals("4", result.getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testUnitPropertyAddAnotherUnit()
    {
        ...
        Assert.assertTrue(Measure.isUnitOrMeasureInstance(result, this.processorSupport));
        Assert.assertEquals("Mass~Gram", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
        Assert.assertEquals("3680.385", result.getValueForMetaPropertyToOne("values").getValueForMetaPropertyToOne("values").getName());
    }
    ...
    public void testClassPropertiesListCanBeInstantiatedWithUnitProperty()
    {
        ...
        compileTestSource("testFunc.pure",
                "import pkg::*;\n" +
                        ...
                        "}\n");
        CoreInstance result = execute("testFunc():Any[*]");
        Assert.assertEquals("List<Property<Nil, Any|*>>", GenericType.print(result.getValueForMetaPropertyToOne("genericType"), this.processorSupport));
    }

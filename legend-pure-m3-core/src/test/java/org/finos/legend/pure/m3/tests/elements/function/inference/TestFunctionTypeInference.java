    ...
    public void columnInference()
    {
        compileInferenceTest(
                "Class Firm{legalName:String[1];}" +
                        ...
                        "function f():Any[*]" +
                        "{" +
                        "   Firm.all()->meta::pure::functions::relation::project(~[legal:x|$x.legalName]);\n" +
                        "}" +
                        "\n" +
                        "native function meta::pure::functions::relation::project<Z,T>(cl:Z[*], x:meta::pure::metamodel::relation::FuncColSpecArray<{Z[1]->Any[*]},T>[1]):meta::pure::metamodel::relation::Relation<T>[1];" +
                        "\n"
        );
    }
    ...
    public void columnInferenceUsingBracketLambda()
    {
        compileInferenceTest(
                "Class Firm{legalName:String[1];}" +
                        ...
                        "function f():Any[*]" +
                        "{" +
                        "   Firm.all()->meta::pure::functions::relation::project(~[legal:{x|$x.legalName}])->map(c|$c.legal);\n" +
                        "}" +
    ...
    public void columnInferenceUsingBracketMultiLambda()
    {
        compileInferenceTest(
                "Class Firm{legalName:String[1];}" +
                        ...
                        "function f():Any[*]" +
                        "{" +
                        "   Firm.all()->meta::pure::functions::relation::project(~[legal:{x|$x.legalName},legalMod:{x|$x.legalName+'ok'}])->meta::pure::functions::relation::map(x|$x.legal + $x.legalMod);\n" +
                        "}" +
                        "native function meta::pure::functions::relation::map<T,V>(rel:meta::pure::metamodel::relation::Relation<T>[1], f:Function<{T[1]->V[*]}>[1]):V[*];" +
                        "\n" +
                        "native function meta::pure::functions::relation::project<Z,T>(cl:Z[*], x:meta::pure::metamodel::relation::FuncColSpecArray<{Z[1]->Any[*]},T>[1]):meta::pure::metamodel::relation::Relation<T>[1];" +

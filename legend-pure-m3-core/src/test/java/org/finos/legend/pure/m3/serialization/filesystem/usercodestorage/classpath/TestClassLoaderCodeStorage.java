...
public class TestClassLoaderCodeStorage
{
    ...
    public void testGetUserFiles()
    {
        ...
        Verify.assertSetsEqual(
                Sets.mutable.with("/platform/pure/test.pure", "/platform/pure/out/executionPlan.pure", "/platform/pure/access.pure", "/platform/pure/collection.pure", "/platform/pure/equality.pure", "/platform/pure/grammar.pure", "/platform/pure/milestoning.pure", "/platform/pure/telemetry.pure", "/platform/pure/out/documentation.pure", "/platform/pure/m3.pure", "/platform/pure/path.pure", "/platform/pure/routing.pure", "/platform/pure/service.pure", "/platform/pure/out/tools.pure", "/platform/pure/graph.pure", "/test/codestorage/fake.pure", "/test/org/finos/legend/pure/m3/serialization/filesystem/test/level1/level1.pure", "/test/org/finos/legend/pure/m3/serialization/filesystem/test/level1/level2/level2.pure"),

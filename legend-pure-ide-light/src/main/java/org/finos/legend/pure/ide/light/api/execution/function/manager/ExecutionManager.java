...
public class ExecutionManager
{
    ...
    {
        OutputFormat format = this.getOutputFormat(executionRequest.getRequestParams());
        ...
        else
        {
            ...
            {
                httpInformation = new HttpInformation(OutputFormat.JSON.getDefaultContentType().getType(), null);
            }
        }
    ...
    private boolean isStreamingOutputFunction(ExecutionRequest executionRequest, OutputFormat format)
    {
        return false;
...
//                (param != null && param.length == 1 && (PatternExecutor.func.equals(param[0]) || TDS_TO_JSON_OBJECT_FUNCTION.equals(param[0]))));
    ...
    private OutputFormat getOutputFormat(Map<String, String[]> requestParams)
    {

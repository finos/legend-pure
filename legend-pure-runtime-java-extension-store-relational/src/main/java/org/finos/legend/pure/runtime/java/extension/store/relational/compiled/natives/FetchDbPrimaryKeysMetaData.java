...
public class FetchDbPrimaryKeysMetaData extends AbstractNative
{
    public FetchDbPrimaryKeysMetaData()
    {
        super("fetchDbPrimaryKeysMetaData_DatabaseConnection_1__String_$0_1$__String_1__ResultSet_1_");
    }

...
public class LoadValuesToDbTable extends NativeFunction
{
    private final ModelRepository repository;
    private final Message message;


    public LoadValuesToDbTable(ModelRepository repository, Message message)
    {
    ...
    private FastList<FastList<String>> getRows(Iterable<? extends CoreInstance> tableData, ProcessorSupport processorSupport)
    {

        FastList<FastList<String>> rows = FastList.newList();
        ...
        for (CoreInstance row : tableData)
        {
            ...
            FastList<String> rowIterable = FastList.newList();

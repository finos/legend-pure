...
//    private static final String TestRedshiftDatabaseConnection = "meta::relational::runtime::TestRedshiftDatabaseConnection";
...
//
//        System.out.println("forcing redshift run");
//        if (processorSupport.instance_instanceOf(connectionInformation, TestDatabaseConnection))
//        {
//            return testDatabaseConnect.getConnectionWithDataSourceInfo(IdentityManager.getAuthenticatedUserId());
//        }
...
//            throw new RuntimeException(connectionInformation + " hey is not supported for execution!!");
        }
            ...
            throw new RuntimeException(connectionInformation + " iss not supported for execution!!");
        }
        throw new RuntimeException(connectionInformation + " typee is not ok!?");
    ...
    public static class StatementProperties
    {
        ...
        {
            this.sql = sql;
            System.out.println("poiuy this is sql:" + sql);

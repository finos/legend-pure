...
public class TestFunctionTypeInferenceInPath extends AbstractPureTestWithCoreCompiled
{
    ...
    {
        compileTestSource("id.pure", "import meta::pure::tests::model::simple::*;\n" +
    ...
    @Test
    public void inferTypeParameterUpAndDownWithNestedFunction() throws Exception
    {
        compileTestSource("id.pure", "import meta::pure::tests::model::simple::*;\n" +
                "Class meta::pure::tests::model::simple::Product\n" +
                "{\n" +
        ...
        {
            assertPureException(PureCompilationException.class, "Can't find the property 'name' in the class meta::pure::tests::model::simple::Trade", "id.pure", 36, 115, e);
        }
    }

    @Test
    public void inferTheTypeOfACollectionOfLambdaAndPath()
    {
        this.runtime.loadAndCompile();

        compileTestSource("id.pure", "Class Person{age:Integer[1];}\n" +

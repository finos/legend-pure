...
public class NavigationParser
{
    ...
    {
        org.finos.legend.pure.m3.inlinedsl.path.serialization.grammar.NavigationParser parser = this.initAntlrParser(useFastParser, code, sourceName, offsetLine, offsetColumn, addLines);
        try
        {

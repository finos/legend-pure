...
package org.finos.legend.pure.m3.inlinedsl.graph.incremental;
...
public class TestPureRuntimeGraph extends AbstractPureTestWithCoreCompiled
{
    ...
    public void testPureRuntimeGraphRemoveClass()
    {
        RuntimeVerifier.verifyOperationIsStable(new RuntimeTestScriptBuilder()
                ...
                new RuntimeTestScriptBuilder()
                        ...
                        .compileWithExpectedCompileFailure("A has not been defined!", "source2.pure", 1, 36)
    ...
    public void testPureRuntimeGraphDeleteClass()
    {
        ...
        RuntimeVerifier.deleteCompileAndReloadMultipleTimesIsStable(this.runtime, this.functionExecution,
                Lists.fixedSize.of(Tuples.pair(sourceId, source)), "A has not been defined!", "userId.pure", 1, 36);
    }
    ...
    {
        RuntimeVerifier.verifyOperationIsStable(new RuntimeTestScriptBuilder()
                        .createInMemorySource("source1.pure", "Class A{version : Integer[1];b:B[1];}Class B{} Class C extends B{}")
                ...
                new RuntimeTestScriptBuilder()
                        ...
                        .compileWithExpectedCompileFailure("C has not been defined!", "source2.pure", 1, 58)
                        .updateSource("source1.pure", "Class A{version : Integer[1];b:B[1];}Class B{} Class C extends B{}")
                        .compile()
                , this.runtime, this.functionExecution, Lists.fixedSize.<FunctionExecutionStateVerifier>of());
    }

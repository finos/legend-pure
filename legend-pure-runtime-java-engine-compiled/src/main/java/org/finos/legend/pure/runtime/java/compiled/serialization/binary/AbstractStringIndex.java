...
abstract class AbstractStringIndex implements StringIndex
{
    private final String[] classifierIds;

    protected AbstractStringIndex(String[] classifierIds)
    {
    ...
    public String getString(int id)
    {
        ...
        if (id < this.classifierIds.length)
        {
            return this.classifierIds[id];
        }
        try
        {
            return getOtherString(id - this.classifierIds.length);
        }

...
package org.finos.legend.pure.runtime.java.compiled.generation.processors.natives.core.collection.map;
...
public class NewMapWithProperties extends AbstractNativeFunctionGeneric
{
    ...
    {
        super("CoreGen.newMap", new Class[]{RichIterable.class, RichIterable.class, ExecutionSupport.class}, false, true, false, "newMap_Pair_MANY__Property_MANY__Map_1_");
    }

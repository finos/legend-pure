...
public abstract class BaseJavaModelCoreInstanceFactory implements CoreInstanceFactory
{
    @Override
    public boolean supports(CoreInstance classifier)
    {
        return this.supports(JavaPackageAndImportBuilder.buildPackageForPackageableElement(classifier));
    }

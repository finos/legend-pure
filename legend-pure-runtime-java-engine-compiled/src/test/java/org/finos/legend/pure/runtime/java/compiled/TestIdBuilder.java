...
public class TestIdBuilder
{
    ...
    {
        MutableRepositoryCodeStorage codeStorage = PureCodeStorage.createCodeStorage(null, Lists.immutable.with(CodeRepositoryProviderHelper.findPlatformCodeRepository()));

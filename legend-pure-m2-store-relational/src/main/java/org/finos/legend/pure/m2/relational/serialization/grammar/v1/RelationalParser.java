...
import org.finos.legend.pure.m3.coreinstance.RelationalCoreInstanceFactoryRegistry;
...
public class RelationalParser implements IRelationalParser
{
    ...
    {
        return Lists.immutable.with(RelationalCoreInstanceFactoryRegistry.REGISTRY, RelationalCoreInstanceFactoryRegistry.REGISTRY);
    }
    ...
    {
        return Lists.immutable.with("/platform/relational/relational_internal.pure", "/platform/relational/relationalMapping_internal.pure", "/platform/relational/relational.pure", "/platform/relational/relationalMapping.pure", "/platform/relational/relationalRuntime.pure");
    }

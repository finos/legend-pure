...
public class FromJsonDeprecated extends NativeFunction
{
    ...
    public CoreInstance execute(ListIterable<? extends CoreInstance> params, Stack<MutableMap<String, CoreInstance>> resolvedTypeParameters, Stack<MutableMap<String, CoreInstance>> resolvedMultiplicityParameters, VariableContext variableContext, CoreInstance functionExpressionToUseInStack, Profiler profiler, InstantiationContext instantiationContext, ExecutionSupport executionSupport, Context context, ProcessorSupport processorSupport) throws PureExecutionException
    {
        ...
        ListIterable<CoreInstance> functionParameters =
                Lists.immutable.with(ValueSpecificationBootstrap.wrapValueSpecification(jsonElement, true, processorSupport) , startingclass, config );

        return functionExecution.executeLambdaFromNative(fromContractStoreJSONFunction, functionParameters, resolvedTypeParameters, resolvedMultiplicityParameters, variableContext, functionExpressionToUseInStack, profiler, instantiationContext, executionSupport);

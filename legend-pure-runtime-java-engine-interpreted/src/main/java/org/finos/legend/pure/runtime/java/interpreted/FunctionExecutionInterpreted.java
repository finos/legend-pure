...
public class FunctionExecutionInterpreted implements FunctionExecution
{
    ...
    public void init(PureRuntime runtime, Message message)
    {
        ...
        this.nativeFunctions.put("toOne_T_MANY__T_1_", new ToOne(repository, false));
        this.nativeFunctions.put("toOne_T_MANY__String_1__T_1_", new ToOne(repository, true));
        this.nativeFunctions.put("toOneMany_T_MANY__T_$1_MANY$_", new ToOneMany(repository, false));
        this.nativeFunctions.put("toOneMany_T_MANY__String_1__T_$1_MANY$_", new ToOneMany(repository, true));

...
package org.finos.legend.pure.runtime.java.interpreted.natives.grammar._boolean.equality;
...
public class Equal extends NativePredicate
{
    public Equal(ModelRepository repository)
    {
        super(repository);
    }
    ...
    {
        return EqualityUtilities.equal(Instance.getValueForMetaPropertyToManyResolved(params.get(0), M3Properties.values, processorSupport), Instance.getValueForMetaPropertyToManyResolved(params.get(1), M3Properties.values, processorSupport), processorSupport);
    }
}

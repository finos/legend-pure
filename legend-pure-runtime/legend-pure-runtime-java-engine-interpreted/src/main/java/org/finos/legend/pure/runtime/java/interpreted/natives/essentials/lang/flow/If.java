...
package org.finos.legend.pure.runtime.java.interpreted.natives.essentials.lang.flow;
...
public class If extends NativeFunction
{
    private static final MutableList<CoreInstance> EMPTY_PARAMS = Lists.mutable.with();

    private final FunctionExecutionInterpreted functionExecution;

    public If(FunctionExecutionInterpreted functionExecution)
    {

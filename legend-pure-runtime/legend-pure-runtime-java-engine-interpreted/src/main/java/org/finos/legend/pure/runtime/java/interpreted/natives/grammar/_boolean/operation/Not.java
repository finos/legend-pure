...
package org.finos.legend.pure.runtime.java.interpreted.natives.grammar._boolean.operation;
...
public class Not extends NativePredicate
{
    public Not(ModelRepository repository)
    {
        super(repository);
    }
    ...
    {
        return !PrimitiveUtilities.getBooleanValue(Instance.getValueForMetaPropertyToOneResolved(params.get(0), M3Properties.values, processorSupport));
    }
}

...
package org.finos.legend.pure.runtime.java.interpreted.natives.essentials.date.creation;
...
public class NewDate extends NativeFunction
{
    ...
    private IntObjectPair<String> getSecondAndSubSecond(CoreInstance valueSpec, ProcessorSupport processorSupport) throws PureExecutionException
    {
        ...
        return PrimitiveTuples.pair(Integer.parseInt(valueName.substring(0, decimalIndex)), valueName.substring(decimalIndex + 1));
    }
}

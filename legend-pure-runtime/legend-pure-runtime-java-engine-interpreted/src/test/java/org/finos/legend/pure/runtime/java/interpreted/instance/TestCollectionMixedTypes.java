...
public class TestCollectionMixedTypes extends AbstractPureTestWithCoreCompiled
{
    ...
    public void testSimple()
    {
        ...
        Assert.assertEquals("Any", GenericType.print(genericType, processorSupport));
    }
    ...
    public void testWithTypeArguments()
    {
        ...
        Assert.assertEquals("MyType<A>", GenericType.print(genericTypes.get(0), processorSupport));
        Assert.assertEquals("MyType<Any>", GenericType.print(genericTypes.get(1), processorSupport));
    }
    ...
    public void testWithTypeMultiplicities()
    {
        ...
        CoreInstance result = execute("test():GenericType[1]");
        CoreInstance genericType = result.getValueForMetaPropertyToOne(M3Properties.values);
        Assert.assertEquals("MyType<|1..5>", GenericType.print(genericType, processorSupport));
    }
    ...
    public void testWithTypeMultiplicitiesWithMany()
    {
        ...
        CoreInstance result = execute("test():GenericType[1]");
        CoreInstance genericType = result.getValueForMetaPropertyToOne(M3Properties.values);
        Assert.assertEquals("MyType<|*>", GenericType.print(genericType, processorSupport));
    }

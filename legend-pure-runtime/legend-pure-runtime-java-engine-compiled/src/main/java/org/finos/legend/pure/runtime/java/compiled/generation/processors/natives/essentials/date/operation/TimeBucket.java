...
public class TimeBucket extends AbstractNativeFunctionGeneric
{
    public TimeBucket()
    {
        super("CoreGen.timeBucket", new Class[]{DateTime.class, Long.class, org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.type.Enum.class}, "timeBucket_DateTime_1__Integer_1__DurationUnit_1__DateTime_1_");
    }
}

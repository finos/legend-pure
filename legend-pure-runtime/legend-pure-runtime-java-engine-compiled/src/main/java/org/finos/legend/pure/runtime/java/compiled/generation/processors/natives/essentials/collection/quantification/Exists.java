...
package org.finos.legend.pure.runtime.java.compiled.generation.processors.natives.essentials.collection.quantification;
...
public class Exists extends AbstractNativeFunctionGeneric
{
    public Exists()
    {
        super("CoreGen.exists", new Class[]{Object.class, Predicate.class}, "exists_T_MANY__Function_1__Boolean_1_");
    }
    ...
    public String build(CoreInstance topLevelElement, CoreInstance functionExpression, ListIterable<String> transformedParams, ProcessorContext processorContext)
    {
        ...
        return "null".equals(list) ? "false" : "CoreGen.exists(" + list + ", new DefendedPredicate<" + type + ">(){private final PureFunction1<" + type + ",Boolean> func = (PureFunction1<" + type + ",Boolean>)CoreGen.getSharedPureFunction(" + transformedParams.get(1) + ",es); public boolean accept(" + type + " param){return func.value(param, es);}})\n";
    }
    ...
    public String buildBody()
    {
        ...
        return "new DefendedPureFunction2<Object, Object, Boolean>()\n" +
                ...
                "                           }\n" +
                "                     };\n" +
                "                return CoreGen.exists(t, predicate);\n" +
                "            }\n" +
                "        }";
    }

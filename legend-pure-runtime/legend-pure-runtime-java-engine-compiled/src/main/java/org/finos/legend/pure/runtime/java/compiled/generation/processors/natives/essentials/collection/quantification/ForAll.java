...
public class ForAll extends AbstractNativeFunctionGeneric
{
    public ForAll()
    {
        super("CoreGen.forAll", new Class[]{Object.class, Predicate.class}, "forAll_T_MANY__Function_1__Boolean_1_");
    }
    ...
    public String build(CoreInstance topLevelElement, CoreInstance functionExpression, ListIterable<String> transformedParams, ProcessorContext processorContext)
    {
        ...
        return "null".equals(list) ? "true" : "CoreGen.forAll(" + list + ", new DefendedPredicate<" + type + ">(){PureFunction1<" + type + ",Boolean> func=(PureFunction1<" + type + ",Boolean>)CoreGen.getSharedPureFunction(" + transformedParams.get(1) + ",es); public boolean accept(" + type + " param){return func.value(param,es);}})\n";
    }

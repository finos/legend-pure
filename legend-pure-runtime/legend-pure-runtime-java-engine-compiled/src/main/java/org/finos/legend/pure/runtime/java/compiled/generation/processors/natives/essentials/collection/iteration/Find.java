...
public class Find extends AbstractNative implements Native
{
    public Find()
    {
        super("find_T_MANY__Function_1__T_$0_1$_");
    }
    ...
    public String build(CoreInstance topLevelElement, CoreInstance functionExpression, ListIterable<String> transformedParams, ProcessorContext processorContext)
    {
        ...
        if (isLambdaFunction)
        {
            ...
            return "CompiledSupport.toPureCollection(" + list + ").detect(new DefendedPredicate<" + paramTypeObject + ">(){public boolean accept(final " + paramTypeObject + " _" + paramName + "){" + FunctionProcessor.processFunctionDefinitionContent(topLevelElement, Instance.getValueForMetaPropertyToOneResolved(parametersValues.get(1), M3Properties.values, processorSupport), true, processorContext, processorSupport) + "}})";
        }
        else
        {
            return "CompiledSupport.toPureCollection(" + list + ").detect(new DefendedPredicate<" + paramTypeObject + ">(){private final PureFunction1<" + paramTypeObject + ",Boolean> func=(PureFunction1<" + paramTypeObject + ",Boolean>)CoreGen.getSharedPureFunction(" + transformedParams.get(1) + ",es); public boolean accept(final " + paramTypeObject + " _var){return func.value(_var,es);}})";
        }
    }
    ...
    public String buildBody()
    {
        return "new DefendedPureFunction2<Object, Object, Object>()\n" +
                ...
                "                return CompiledSupport.toPureCollection(p1).detect(new DefendedPredicate<Object>(){PureFunction1<Object,Boolean> funcC=(PureFunction1<Object,Boolean>)CoreGen.getSharedPureFunction(func, es); public boolean accept(final Object _var){return funcC.value(_var, es);}});\n" +
                "            }\n" +
                "        }";
    }
}

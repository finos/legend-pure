...
public class Last extends AbstractNative
{
    ...
    public String build(CoreInstance topLevelElement, CoreInstance functionExpression, ListIterable<String> transformedParams, ProcessorContext processorContext)
    {
        ...
        return "CoreGen.last(" + (castToIterable ? "(" + TypeProcessor.typeToJavaObjectWithMul(expression.getValueForMetaPropertyToOne(M3Properties.genericType), expression.getValueForMetaPropertyToOne(M3Properties.multiplicity), processorSupport) + ")" : "") + transformedParams.get(0) + ")";
    }
    ...
    public String buildBody()
    {
        return "new DefendedPureFunction1<Object, Object>()\n" +
                ...
                "            {\n" +
                "                return input instanceof RichIterable ? CoreGen.last((RichIterable<?>) input) : CoreGen.last(input);\n" +
                "            }\n" +
                "        }";
    }
}

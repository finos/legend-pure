...
public class At extends AbstractNativeFunctionGeneric
{
    ...
    public String build(CoreInstance topLevelElement, CoreInstance functionExpression, ListIterable<String> transformedParams, ProcessorContext processorContext)
    {
        ...
        String castType = TypeProcessor.typeToJavaObjectSingle(Instance.getValueForMetaPropertyToOneResolved(parametersValues.get(0), M3Properties.genericType, processorSupport), true, processorSupport);

        return "((" + castType + ")" + super.build(topLevelElement, functionExpression, transformedParams, processorContext) + ")";
    }
}

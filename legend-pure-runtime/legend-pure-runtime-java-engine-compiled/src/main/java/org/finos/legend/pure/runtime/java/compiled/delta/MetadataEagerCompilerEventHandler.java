...
public class MetadataEagerCompilerEventHandler implements CompilerEventHandlerMetadataProvider
{
    ...
    {
        if (this.metadataEager == null)
        {
            throw new IllegalStateException("Metadata must be built before starting transaction");
        }
    ...
    public void rollbackTransaction()
    {
        if (this.metadataEager == null)
        {
            throw new IllegalStateException("Metadata must be built before rolling back transaction");
        }
    ...
    public void invalidate(RichIterable<? extends CoreInstance> consolidatedCoreInstances)
    {
        if (this.metadataEager == null)
        {
            throw new IllegalStateException("Metadata must be built invalidating instances");
        }
    ...
    public void reset()
    {
        ...
        this.metadataEager = new MetadataEager(this.processorSupport);
    }

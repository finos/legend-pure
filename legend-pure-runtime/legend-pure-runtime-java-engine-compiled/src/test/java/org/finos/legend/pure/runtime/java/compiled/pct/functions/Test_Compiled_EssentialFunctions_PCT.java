...
public class Test_Compiled_EssentialFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final String manifestPath = "platform/pure/essential/pct_essential_native.json";

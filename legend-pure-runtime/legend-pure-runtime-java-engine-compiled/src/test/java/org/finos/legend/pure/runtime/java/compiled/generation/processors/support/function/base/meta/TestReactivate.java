...
public class TestReactivate extends AbstractTestReactivate
{
    ...
    public void testVariableScopeFail()
    {
        ...
        String folder = JavaPackageAndImportBuilder.rootPackage().replace('.', '/');
        String expected = Pattern.quote("1 error compiling /" + folder + "/DynaClass.java\n" +
                "/" + folder + "/DynaClass.java:") + "\\d*" + Pattern.quote(": error: cannot find symbol\n" +

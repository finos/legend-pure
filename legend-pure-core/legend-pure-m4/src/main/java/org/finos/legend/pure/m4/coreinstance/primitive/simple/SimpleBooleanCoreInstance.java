...
class SimpleBooleanCoreInstance extends AbstractSimplePrimitiveCoreInstance<Boolean> implements BooleanCoreInstance
{
    SimpleBooleanCoreInstance(Boolean value, CoreInstance classifier, int internalSyntheticId)
    {
    ...
    {
        return new SimpleBooleanCoreInstance(getValue(), getClassifier(), getSyntheticId());
    }
}

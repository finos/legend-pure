...
public class BaseReferenceTest extends AbstractPureTestWithCoreCompiled
{
    protected static final GenericCodeRepository REF_TEST_REPO = GenericCodeRepository.build("ref_test", "test(::.*)?", "platform");

    protected static final String REF_TEST_SOURCE_ID = "/ref_test/test.pure";

    protected static final String REF_TEST_SOURCE_CODE = "import test::model::*;\n" +
            "\n" +
    ...
    {
        return Lists.mutable.<CodeRepository>withAll(AbstractPureTestWithCoreCompiled.getCodeRepositories()).with(REF_TEST_REPO);
    }

    public static Pair<String, String> getExtra()
    {
        return Tuples.pair(REF_TEST_SOURCE_ID, REF_TEST_SOURCE_CODE);
    }
    ...
    {
        RichIterable<? extends Property<?, ?>> properties = (owner instanceof org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.type.Class) ? ((org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.type.Class<?>) owner)._properties() : ((Association) owner)._properties();
    ...
    {
        RichIterable<? extends QualifiedProperty<?>> qualifiedProperties = (owner instanceof org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.type.Class) ? ((org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.type.Class<?>) owner)._qualifiedProperties() : ((Association) owner)._qualifiedProperties();

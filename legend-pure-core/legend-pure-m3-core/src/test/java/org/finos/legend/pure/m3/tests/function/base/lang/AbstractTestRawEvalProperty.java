    ...
    public void objectDoesntHavePropertyFail()
    {
        try
        {
            this.compileTestSource("Class Person\n" +
                    ...
                    "   print(Person.properties -> filter(p | $p.name == 'name') -> toOne() -> rawEvalProperty($alien), 1);\n" +
                    "}");
        ...
        {
            this.assertPureException(PureExecutionException.class, "Can't find the property 'name' in the class Alien", 13, 75, e);
        }
    }
}

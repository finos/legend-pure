...
public class AbstractTestColSpecAnnotations extends AbstractPureTestWithCoreCompiled
{
    @After
    ...
    public void testSimpleColumnWithStereotype()
    {
        compileTestSource("testSource.pure",
                ...
                "function go():Any[*]\n" +
                        ...
                        "   print($columns->at(0).stereotypes);\n" +
...
//                        "   assertEquals('ignore', $columns->at(0).stereotypes->at(0).value);\n" +
        ...
        execute("go():Any[*]");
        System.out.println(this.functionExecution.getConsole().getLine(0));
    }

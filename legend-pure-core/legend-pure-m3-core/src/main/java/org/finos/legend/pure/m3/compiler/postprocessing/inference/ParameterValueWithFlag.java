...
class ParameterValueWithFlag
{
    ...
    ParameterValueWithFlag(CoreInstance parameterValue, TypeInferenceContext targetGenericsContext, boolean isFinal)
    {
        this.parameterValue = parameterValue;
        this.targetGenericsContext = targetGenericsContext;

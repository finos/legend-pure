...
public class PrintPureRuntimeStatus implements PureRuntimeStatus
{
    ...
    private String print(CoreInstance coreInstance)
    {
        ...
        {
            return "[InstanceValue: '" + coreInstance.getValueForMetaPropertyToMany(M3Properties.values).collect(i ->
            {
                CoreInstance importStubId = i.getValueForMetaPropertyToOne(M3Properties.idOrPath);

...
public class TypeUnloaderWalk implements MatchRunner<Type>
{
    @Override
    ...
    {
        for (Generalization specialization : type._specializations())
        {
            matcher.fullMatch(specialization, state);
        }
    }
}

...
public class TemporaryPureAggregateSpecification
{
    ...
    public MutableList<TemporaryPureGroupByFunctionSpecification> groupByFunctionSpecifications;
    public MutableList<TemporaryPureAggregationFunctionSpecification> aggregationFunctionSpecifications;

    TemporaryPureAggregateSpecification(SourceInformation sourceInformation, int index, boolean canAggregate, MutableList<TemporaryPureGroupByFunctionSpecification> groupByFunctionSpecifications, MutableList<TemporaryPureAggregationFunctionSpecification> aggregationFunctionSpecifications)
    {
        this.sourceInformation = sourceInformation;
        this.index = index;
        this.canAggregate = canAggregate;
        this.groupByFunctionSpecifications = Lists.mutable.withAll(groupByFunctionSpecifications);

...
public class PureJarGenerator
{
    ...
    {
//        doGeneratePAR(parGenerateParams.repositories,
//                parGenerateParams.excludedRepositories,
//                parGenerateParams.extraRepositories,
//                parGenerateParams.purePlatformVersion,
//                parGenerateParams.purePlatformVersion,
//                parGenerateParams.modelVersion,
//                parGenerateParams.sourceDirectory,
//                parGenerateParams.outputDirectory,
//                Thread.currentThread().getContextClassLoader(),
//                parGenerateParams.log);
//    }
...
//    {
        ...
        try
        {
            ...
            parGenerateParams.getLog().debug("  Requested repositories: " + parGenerateParams.getRepositories());
            parGenerateParams.getLog().debug("  Excluded repositories: " + parGenerateParams.getExcludedRepositories());
            parGenerateParams.getLog().debug("  Extra repositories: " + parGenerateParams.getExtraRepositories());
            CodeRepositorySet resolvedRepositories = resolveRepositories(parGenerateParams.getRepositories(), parGenerateParams.getExcludedRepositories(), parGenerateParams.getExtraRepositories(), cl, parGenerateParams.getLog());
            parGenerateParams.getLog().debug("  Specified repositories (with resolved dependencies): " + resolvedRepositories.getRepositories().collect(CodeRepository::getName).makeString("[", ",", "]"));
            parGenerateParams.getLog().debug("  Register DSLs: " + ps.parsers().collect(Parser::getName).makeString(", "));
            parGenerateParams.getLog().debug("  Register in-line DSLs: " + ps.inlineDSLs().collect(InlineDSL::getName).makeString(", "));
            parGenerateParams.getLog().debug("  Pure platform version: " + parGenerateParams.getPurePlatformVersion());
            parGenerateParams.getLog().debug("  Model version: " + parGenerateParams.getModelVersion());
            parGenerateParams.getLog().debug("  Pure source directory: " + parGenerateParams.getSourceDirectory());
            parGenerateParams.getLog().debug("  Output directory: " + parGenerateParams.getOutputDirectory());
